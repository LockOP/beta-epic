...
export const preview3RefConfigs: RefConfigs = {
  metricCard: {
    component: "Card",
    props: {
      className: "h-[198px] rounded-xl shadow-sm",
    },
    children: [
      {
            ...
            props: {
              ...
              className: {
                "$if": {
                  ...
                  then: "gap-1 rounded-md border-green-200 bg-green-50 px-2 py-0.5 text-xs font-medium text-green-700",
                    ...
                    "$action": [
                      {
                        type: "snackbar",
                        message: {
                          "$concat": ["Assign reviewer for ", { "$ref": "var:row.title" }],
                        },
                        variant: "info",
                      },
                    ],
                ...
                "$action": [
                  {
                    type: "snackbar",
                    message: {
                      "$concat": ["Opened menu for ", { "$ref": "var:row.title" }],
                    },
                    variant: "info",
                  },
                ],
